...
{{ figure('/assets/images/redesign/previous.png','Previous design of bshow.co, featuring a rather bland appearance','It\'s called MVP for a reason, right?') }}
...
{{ figure('/assets/images/redesign/rough_sketch.jpg','Rough wireframe-style sketch of the new website home page, drawn with digital ink on a dot grid','Home page sketch in Goodnotes 5') }}
...
{{ figure('/assets/images/redesign/colors.png','New color palette of lighter and darker shades of a lavendar-like purple, red, and orange','A nice departure from black on white') }}

{{ figure('/assets/images/redesign/mockup.png','HTML and CSS mockup of new home page','CodePen is a great environment for sussing things out without worrying about scaffolding a particular dev setup') }}
