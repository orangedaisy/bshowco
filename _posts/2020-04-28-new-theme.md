...
{% include "figure" src:'/assets/images/redesign/previous.png' alt:'Previous
...
{% include "figure" src:'/assets/images/redesign/rough_sketch.jpg' alt:'Rough
...
{% include "figure" src:'/assets/images/redesign/colors.png' alt:'New color
...
{% include "figure" src:'/assets/images/redesign/mockup.png' alt:'HTML and
