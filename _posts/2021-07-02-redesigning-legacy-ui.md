...
{{ figure('/assets/images/redesigning_legacy_ui/legacy_qm_details.png','','Quote Manager, early 2019') }}
...
{{ figure('/assets/images/redesigning_legacy_ui/project_portal_details.png','','Project Portal, early 2019') }}
...
{{ figure('/assets/images/redesigning_legacy_ui/details_first_research.png','','Initial questions and observations from reviewing the Quote Manager and comparing its UI/X to Project Portal') }}
...
{{ figure('/assets/images/redesigning_legacy_ui/pqo_differences.png','','Noting the differences between Projects, Quotes, and Orders') }}

I then wrote down a few more thoughts and met again with our Senior VP to
discuss an action plan for creating mockups.

{{ figure('/assets/images/redesigning_legacy_ui/details_more_research.png','','More Projects, Quotes, and Orders notes, along with an action plan for getting into mockups') }}
...
{{ figure('/assets/images/redesigning_legacy_ui/details_new_tabs.png','','Determining how to harmonize multiple different content architectures') }}
...
{{ figure('/assets/images/redesigning_legacy_ui/current_tab_style.png','','Details view mockup with the original vertical tab style') }}

{{ figure('/assets/images/redesigning_legacy_ui/new_tab_style.png','','New tab style with background panel') }}

{{ figure('/assets/images/redesigning_legacy_ui/new_tab_style_alt.png','','New tab style with an additional new card header element') }}
...
{{ figure('/assets/images/redesigning_legacy_ui/activity.png','','Improved Activity Log') }}
...
{{ figure('/assets/images/redesigning_legacy_ui/related_work.png','','Related Work concept') }}
...
{{ figure('/assets/images/redesigning_legacy_ui/pqm_details_overview.png','','New Overview tab of the Project / Quote Manager application') }}

{{ figure('/assets/images/redesigning_legacy_ui/pqm_details_equipment.png','','New Equipment tab of the Project / Quote Manager application') }}

{{ figure('/assets/images/redesigning_legacy_ui/pqm_details_documents.png','','New Documents tab of the Project / Quote Manager application') }}
