...
{{ figure('/assets/images/github_custom_domain_https.png','Enable HTTPS for Custom Domain on GitHub Pages','Checkbox to enable HTTPS for Custom Domains on GitHub Pages') }}

One of my domains doesn't seem compatible at the moment, however:

{{ figure('/assets/images/github_custom_domain_no_https.png','Domain unable to use HTTPS',"Can't enable HTTPS for this domain. Name redacted because it's undergoing a redesign :\)") }}
