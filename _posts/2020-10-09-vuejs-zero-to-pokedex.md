...
{% include "figure" src:'/assets/images/pokedex_first_sketches.jpg'
...
{% include "figure" src:'/assets/images/pokedex_v2.jpg' alt:'Wireframes and
...
{% include "figure" src:'/assets/images/pokedex_final_flow.jpg'
...
{% include "figure" src:'/assets/images/owen_pokemon_hunter.jpg' alt:'Picture
